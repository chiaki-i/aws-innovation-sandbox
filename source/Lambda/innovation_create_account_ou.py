...
def validate_inputs(mgmt_name, sbx_name, mgmt_email, sbx_email, mgmt_ou, sbx_ou, client, root):
    ...
    if not re.match('^[a-zA-Z0-9_.+-]+@([a-zA-Z0-9][\w-]*[a-zA-Z0-9]*.)+[a-zA-Z]{2,3}$', mgmt_email.lower()) or not re.match(
            '^[a-zA-Z0-9_.+-]+@([a-zA-Z0-9][\w-]*[a-zA-Z0-9]*.)+[a-zA-Z]{2,3}$', sbx_email.lower()):
